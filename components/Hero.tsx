...
const Hero: React.FC = () => {
  return (
    <section id="about" className="min-h-screen flex items-center pt-20 pb-16 bg-offwhite overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        ...
        <div className="order-2 md:order-1 space-y-6">
          ...
          >
            ...
            <h1 className="font-serif text-4xl md:text-7xl text-charcoal font-medium leading-tight">
              Ademiju <br />
          ...
          >
            ...
            <p className="font-serif text-charcoal/80 text-xl italic">
          ...
          >
            <a
              href="#contact"
              className="inline-block px-8 py-3 bg-charcoal text-white font-sans text-sm tracking-widest hover:bg-terracotta transition-colors duration-300 transform hover:-translate-y-1"
            >
              GET IN TOUCH
            </a>
          </motion.div>
        ...
        >
          <div className="relative w-full max-w-md aspect-[3/4] bg-gray-200 overflow-hidden shadow-2xl rounded-2xl">
            {/* 
                Placeholder for professional headshot. 
                Ideally, replace src with actual image URL.
             */}
            <img
              src="/hero.jpg"
